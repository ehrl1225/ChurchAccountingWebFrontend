...
export default function TransactionTable() {
    ...
    const handleOpenDialog = async (transaction?: ReceiptResponseDto) => {
        if (transaction) {
            fetchCategories(transaction.tx_type);
            ...
            setPrimaryCategory(transaction.category_id.toString());
            setSecondaryCategory(transaction.item_id.toString());
    ...
    const onAdd = async () => {
        ...
        await create_receipt({
            receipt_image_url: receiptImage? receiptImage: null,
